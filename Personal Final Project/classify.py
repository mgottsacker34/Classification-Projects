...
for line in poe2:
	count+=1
	if (count>74 and count < 3454) or (count>4252 and count<9233):
		cl.train(line, 'Edgar Allen Poe')
poe2.close()
...
print 'Twain: ', cl.fisherprob(tocheck,'Mark Twain')*100
print 'Dickens: ', cl.fisherprob(tocheck,'Charles Dickens')*100
print 'Fitzgerald: ', cl.fisherprob(tocheck,'F. Scott Fitzgerald')*100
print 'Poe: ', cl.fisherprob(tocheck,'Edgar Allen Poe')*100
print 'Wilde: ', cl.fisherprob(tocheck,'Oscar Wilde')*100
print 'Shakespeare: ', cl.fisherprob(tocheck,'Shakespeare')*100
print ''
